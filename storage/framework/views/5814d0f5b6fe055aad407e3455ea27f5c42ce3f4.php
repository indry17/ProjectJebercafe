    ...
    <section id="testimonial" class="bg-[url(assets/images/testimonial-bg.jpg')] bg-center bg-cover bg-no-repeat mt-28 px-10 py-24 relative w-full z-1">
      ...
      <div class="m-4 max-w-md mt-5 p-4 text-center text-white mx-auto">
        ...
        <p class="pt-2 text-[14px] font-sans-lato text-slate-100 leading-relaxed"></p>
      </div>
    ...
    <!-- Testimonial Area End --><?php /**PATH C:\Users\GF63\Downloads\laravel_indry\laravel_indry\resources\views/home/partials/testimonial.blade.php ENDPATH**/ ?>