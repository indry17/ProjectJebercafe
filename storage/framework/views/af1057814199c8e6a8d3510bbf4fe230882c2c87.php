	  ...
	  <div class="mx-4 lg:flex lg:items-center">
	    <div class="flex items-center justify-between">
	      <div class="lg:shrink-0">
	        <a href="<?php echo e(route('index')); ?>"><img src="assets/images/logo/logo3.png" alt="logo" class="h-auto lg:m-0 lg:p-2 m-auto max-w-[100px] min-w-[90px] px-2 py-2" /></a>
	      </div>
...
<?php endif; ?>
	...
	<!-- Header Area End -->
				...
				<?php /**PATH C:\Users\GF63\Downloads\laravel_indry\laravel_indry\resources\views/home/partials/header.blade.php ENDPATH**/ ?>