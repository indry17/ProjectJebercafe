                                                ...
                                                <form method="POST" action="<?php echo e(route('user.destroy', $data->id)); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" class="badge badge-danger cursor-pointer"
                                                            onclick="return confirmDeleteUser(<?php echo e($data->id); ?> , '<?php echo e($data->name); ?>');">Delete</button>
                                                    </div>
                                                </form>
                                            </td>
                                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel_indry\resources\views/admin/pages/user.blade.php ENDPATH**/ ?>