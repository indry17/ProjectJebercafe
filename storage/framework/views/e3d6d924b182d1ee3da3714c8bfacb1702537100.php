    ...
    <section class="py-32 mx-auto max-w-[960px]">
      <div class="m-4 max-w-md mt-5 mb-11 p-4 text-center mx-auto">
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Makanan <span class="text-amber-400 leading-snug">special</span> Jeber Cafe Platinum</h3>
        <p class="pt-2 text-[14px] font-sans-lato text-slate-600 leading-relaxed">"Rasa Istimewa, Pengalaman Tak Terlupakan!."</p>
      </div>
        ...
        <div class="p-3 flex flex-wrap items-center justify-around<?php echo e($loop->first ? " mt-0": " mt-10"); ?><?php echo e($loop->iteration % 2 == 0 ? " flex-row-reverse" : ""); ?>">
          <div class="p-5 basis-[400px] grow shrink max-w-[650px]<?php echo e($loop->iteration % 2 == 0 ? " pr-7" : ""); ?>">
            ...
            <div class="<?php echo e($loop->iteration % 2 == 0 ? "text-right" : ""); ?>">
              ...
              <p class="mt-4 font-bold font-cursive-merie text-2xl text-amber-400 ">Rp<?php echo e($data['price']); ?></p>
              <a href="#book">
    ...
    <!-- Deshes Area End --><?php /**PATH C:\Users\GF63\Downloads\laravel_indry\laravel_indry\resources\views/home/partials/deshes.blade.php ENDPATH**/ ?>